...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "logo.jpg",
    "login_logo": "logo.jpg",
    "welcome_sign": "स्वगतम् — Welcome to Watchdog Nepal Admin",
...
if DEBUG:
    ...
    EMAIL_HOST = os.environ.get('EMAIL_HOST', 'mail.watchdognepal.com')
    EMAIL_PORT = int(os.environ.get('EMAIL_PORT', 587))
    EMAIL_USE_TLS = os.environ.get('EMAIL_USE_TLS', 'True') == 'True'
    EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', '')
    EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', '')

DEFAULT_FROM_EMAIL = 'Watchdog Nepal <no-reply@watchdognepal.com>'
